...
class QuantumInspiredFusionModel {
    ...
    companion object {
        ...
        const val ACCELERATION_FALL_THRESHOLD = 30f
        const val JERK_FALL_THRESHOLD = 20f
    ...
    fun computeScore(
        ...
        val isFall = shouldCollapse(totalScore)
    ...
    private fun normalizeAcceleration(accel: Float): Float {
        return (accel / 100f).coerceIn(0f, 1f)
    }

    private fun normalizeJerk(jerk: Float): Float {
        return (jerk / 50f).coerceIn(0f, 1f)
    }
